...
def moneyRateTable(haste, mineIndex, enchantSelection):
    ...
    for index in range(0, mineIndex + 1):
        ...
        if enchantments == False:
            ...
            print(mineInfo[mineAlphabet[index - 1]]["Uniques"]["Fortune"])
            maxFortune = mineInfo[mineAlphabet[index - 1]]["Uniques"]["Fortune"]
...
def rankUpTimeTable(mineIndex, enchantSelection):
    print(moneyRateTable("haste 0", mineIndex, enchantSelection))
