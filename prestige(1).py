...
def pickMineTable(haste, mineIndex):
...
def moneyRateTable(haste, mineIndex):
    moneyRates = {}
    ...
    for index in range(0, mineIndex + 1):
        ...
        for picks in pickMineTable(haste, mineIndex):
            pickList[picks] = 0
    ...
    pickTimeTable = pickMineTable(haste, mineIndex)
...
def rankUpTimeTable(mineIndex):
    haste0Times = moneyRateTable("haste 0", mineIndex)
    haste6Times = moneyRateTable("haste 6", mineIndex)
    haste19Times = moneyRateTable("haste 19", mineIndex)
    hasteListTimes = []
    for mine in range(0, max(1, mineIndex + 1)):
        for pick in moneyRateTable("haste 0", mineIndex)[mineAlphabet[mine]]:
            haste0Times[mineAlphabet[mine]][pick] = round(rankCostRectified(mineIndex)[mineAlphabet[mine]] / moneyRateTable("haste 0", mineIndex)[mineAlphabet[mine]][pick], 2)
            haste6Times[mineAlphabet[mine]][pick] = round(rankCostRectified(mineIndex)[mineAlphabet[mine]] / moneyRateTable("haste 6", mineIndex)[mineAlphabet[mine]][pick], 2)
            haste19Times[mineAlphabet[mine]][pick] = round(rankCostRectified(mineIndex)[mineAlphabet[mine]] / moneyRateTable("haste 19", mineIndex)[mineAlphabet[mine]][pick], 2)
...
for index in range(mineIndexGlobal):
    print(rankUpTimeTable(index)[0])
    print(rankUpTimeTable(index)[1])
    print(rankUpTimeTable(index)[2])
    for mine in mineAlphabet[index]:
        print(rankUpTimeTable(index)[index][mine])
